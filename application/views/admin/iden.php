                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="">
                        <a href="<?php echo base_url(); ?>admin/datapppk">
                            <i class="fa fa-folder"></i> <span>Data PPPK</span>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3>Data yang telah diidentifikasi</h3>
                            </div><!-- /.box-title -->
                            <div class="box-body">
                               <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="CETAK" href="">
