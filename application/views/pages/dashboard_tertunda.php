          ...
          <div class="col-12">
            <div class="card">
              ...
              <table class="table table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                $connectDB = mysqli_select_db($con, 'osis_db');
                if ($role == 'admin'){
                  $result = mysqli_query($con, "SELECT * from cloud WHERE status_transaksi='Tertunda'");
                  while ($row = mysqli_fetch_array($result)){
                    ...
                    <tr>
                        ...
                        <td>
                        <button class="btn btn-warning" data-toggle="modal" type="button" data-target="#assignto_cloud<?php echo $row['no_form']?>"><span class="glyphicon glyphicon-edit"></span> Assign</button>
                        <button class="btn btn-primary" data-toggle="modal" type="button" data-target="#update_cloud<?php echo $row['no_form']?>"><span class="glyphicon glyphicon-edit"></span> Status</button>
                        <!-- <a href="edit_email?id=<?php echo $row['no_form']; ?>">Update</a> -->
                        </td>
                    </tr>
                    <?php 
                    include 'update_cloud.php';
                    include 'assignto_cloud.php';
                }
                } else if ($role == 'tim teknis'){
                  $result = mysqli_query($con, "SELECT * from cloud WHERE status_transaksi='Tertentu'");
                  while ($row = mysqli_fetch_array($result)){
                    ?>
                    <tr>
                        <td><?php echo $row['no_form']; ?></td>
            ...
            <div class="card">
              ...
              <table class="table table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                $connectDB = mysqli_select_db($con, 'osis_db');
                if ($role == 'admin'){
                $result = mysqli_query($con, "SELECT * from email WHERE status_transaksi='Tertunda'");
                while ($row = mysqli_fetch_array($result)){
                  ?>
                    <tr>
                        <td><?php echo $row['no_form']; ?></td>
                        ...
                        <td><?php echo $row['assign_to']; ?></td>
                        <td>
                        <button class="btn btn-warning" data-toggle="modal" type="button" data-target="#assignto_email<?php echo $row['no_form']?>"><span class="glyphicon glyphicon-edit"></span> Assign</button>
                        <button class="btn btn-primary" data-toggle="modal" type="button" data-target="#update_email<?php echo $row['no_form']?>"><span class="glyphicon glyphicon-edit"></span> Status</button>
                            <!-- <input type="button" name="update" value="Update" id="'.$row['id'] .'" class="btn btn-info btn-xs edit_data" /></td> -->
                        </td>
                    </tr>
                    <?php 
                    include 'update_email.php';
                    include 'assignto_email.php';
                }
                } else if ($role == 'tim teknis'){
                  $result = mysqli_query($con, "SELECT * from email WHERE status_transaksi='Tertunda'");
                  while ($row = mysqli_fetch_array($result)){
