          ...
          <div class="col-12">
            <div class="card">
              ...
              <table class="table table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                $connectDB = mysqli_select_db($con, 'osis_db');
                if ($role == 'admin'){
                  $result = mysqli_query($con, "SELECT * from cloud WHERE status_transaksi='Menunggu Pengguna'");
            ...
            <div class="card">
              ...
              <table class="table table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                $connectDB = mysqli_select_db($con, 'osis_db');
                if ($role == 'admin'){
                $result = mysqli_query($con, "SELECT * from email WHERE status_transaksi='Menunggu Pengguna'");
                while ($row = mysqli_fetch_array($result)){
                  ?>
                    <tr>
                        <td><?php echo $row['no_form']; ?></td>
