...
<body class="fixed">
    ...
    <div class="wrapper">
        ...
        <div class="rightside">
            <div class="page-head">
                <h1>DATA PERMINTAAN PERBAIKAN/PEMELIHARAAN KOMPUTER</h1>
            </div>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>user/pppk" class="btn btn-info no-radius dropdown-toggle">Tambah Data <i class="fa fa-plus"></i></a>
                        <div class="box">
                            <div class="box-title">
                                <h3>Data PPPK</h3>
                            </div><!-- /.box-title -->
                               ...
                               <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            <span class="label label-success">Sudah Diidentifikasi</span>
                                        <?php } ?>
                                        </td>
                                        <td>
