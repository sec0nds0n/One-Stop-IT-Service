...
if($_POST){
    try {
       $sql = "INSERT INTO cloud (nip, unit_kerja, usulan_akun, tgl_transaksi, status_transaksi, assign_to, alasan, kuota, jenis_transaksi) VALUES ('$nip_pemohon', '$unit_kerja', '$usulan_akun', now(), '$status_transaksi', '$assign_to', '$alasan', '$kuota', '$jenis_transaksi')";
       if(!$con->query($sql)){
          echo $con->error;
          die();
        }
