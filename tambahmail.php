...
if($_POST){
    try {
       $sql = "INSERT INTO email (nip, unit_kerja, usulan_akun, tgl_transaksi, status_transaksi, jenis_transaksi) VALUES ('$nip_pemohon', '$unit_kerja', '$usulan_akun', now(), '$status_transaksi', '$jenis_transaksi')";
       if(!$con->query($sql)){
          echo $con->error;
          die();
        }
